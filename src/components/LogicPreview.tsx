      ...
      <ScrollArea className="w-full rounded-lg border border-slate-800 bg-slate-950/50 shadow-inner">
        <pre className="p-4 sm:p-6 font-mono text-xs sm:text-sm leading-relaxed overflow-x-auto">
          <code className="text-slate-300">
            ...
            {"  "}<span className="text-sky-400">if</span> (score &lt;= <span className="text-purple-400">9</span>)  <span className="text-sky-400">return</span> <span className="text-amber-300">"Severe Risk"</span>;{"\n"}
            {"  "}<span className="text-sky-400">if</span> (score &lt;= <span className="text-purple-400">12</span>) <span className="text-sky-400">return</span> <span className="text-amber-300">"High Risk"</span>;{"\n"}
            {"  "}<span className="text-sky-400">if</span> (score &lt;= <span className="text-purple-400">14</span>) <span className="text-sky-400">return</span> <span className="text-amber-300">"Moderate Risk"</span>;{"\n"}
            {"  "}<span className="text-sky-400">if</span> (score &lt;= <span className="text-purple-400">18</span>) <span className="text-sky-400">return</span> <span className="text-amber-300">"Mild Risk"</span>;{"\n"}
            {"  "}{"\n"}
            {"  "}<span className="text-sky-400">return</span> <span className="text-amber-300">"No Risk"</span>;{"\n"}
            {"}"};{"\n\n"}
